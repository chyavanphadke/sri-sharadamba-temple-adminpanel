...
CREATE TABLE `pledgedonation` (
  `PledgeDonationId` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `PledgeId` int(10) unsigned NOT NULL DEFAULT '0',
  `DevoteeId` int(10) unsigned NOT NULL DEFAULT '0',
  `PayMethod` int(10) unsigned NOT NULL DEFAULT '0',
...
-- Dump completed on 2024-06-02 20:48:58
